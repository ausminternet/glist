...
--> statement-breakpoint
CREATE INDEX `idx_shopping_list_items_household_id` ON `shopping_list_items` (`household_id`);--> statement-breakpoint
CREATE INDEX `idx_shopping_list_items_category_id` ON `shopping_list_items` (`category_id`);--> statement-breakpoint
CREATE INDEX `idx_shopping_list_items_list_checked` ON `shopping_list_items` (`household_id`,`checked`);--> statement-breakpoint
CREATE TABLE `shops` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`household_id` text NOT NULL,
