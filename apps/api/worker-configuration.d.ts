/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 85c732f6bab52507ab16281b2a6ff0ed)
// Runtime types generated with workerd@1.20260212.0 2026-02-11 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ShoppingListEventsDO";
	}
	interface Env {
		glist_photos: R2Bucket;
		glist_db: D1Database;
		PHOTO_URL_BASE: "http://localhost:8787/photos";
		API_KEY: string;
		ENVIRONMENT: string;
		SHOPPING_LIST_EVENTS: DurableObjectNamespace<import("./src/index").ShoppingListEventsDO>;
	}
}
